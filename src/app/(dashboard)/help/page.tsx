        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            ...
            <li>
              ...
              <strong>&quot;ID вашого партнера&quot;</strong>
            </li>
            <li>
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-1 mb-2">
              <li>
                <strong>Щоденне</strong> - стандартні повідомлення кохання
              </li>
              <li>
                <strong>Екстра</strong> - особливі повідомлення для важливих
                подій
              </li>
            </ul>
            <li>
              Натисніть <strong>&quot;Зберегти&quot;</strong> для додавання
              повідомлення
            </li>
            <li>
