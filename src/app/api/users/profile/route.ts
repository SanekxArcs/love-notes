...
export async function PUT(request: Request) {
  try {
    ...
    const allowedFields = ['name', 'password', 'phone', 'partnerIdToReceiveFrom', 'dayMessageLimit','partnerIdToSend', 'geminiApiKey', 'partnerInfo', 'aiScanLanguage', 'localScanLanguage'];
