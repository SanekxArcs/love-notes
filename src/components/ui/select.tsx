...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "group min-w-0 data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive flex h-11 w-full items-center justify-between rounded-[1rem] border border-white/70 bg-white/45 px-4 py-2 text-sm whitespace-nowrap shadow-[inset_0_1px_0_rgba(255,255,255,.8),0_5px_14px_rgba(71,40,62,.06)] backdrop-blur-xl transition-[color,box-shadow,background-color] outline-none hover:bg-white/60 focus-visible:border-pink-300/70 focus-visible:ring-3 focus-visible:ring-pink-400/20 disabled:cursor-not-allowed disabled:opacity-50 dark:border-white/10 dark:bg-white/6 dark:hover:bg-white/10 dark:focus-visible:border-pink-700/60 *:data-[slot=select-value]:min-w-0 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
